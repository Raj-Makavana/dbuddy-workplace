...
describe('SignupForm Component', () => {
    ...
    test('form submit displays verification email sent message on success', async () => {
        ...
        await waitFor(() => {
            expect(document.querySelector('.bg-green-50')).toHaveTextContent('Verification email sent');
    ...
    test('form submit catches error and displays error message', async () => {
        ...
        await waitFor(() => {
            expect(document.querySelector('.text-red-500')).toHaveTextContent('Email already exists');
        });
    });
    ...
    test('rate-limit cooldown from server counts down and enables resend', async () => {
        ...
        await waitFor(() => expect(document.querySelector('.bg-green-50')).toHaveTextContent('Verification email sent'));
    ...
    test('error clears when form is submitted again after error', async () => {
        ...
        await waitFor(() => {
            expect(document.querySelector('.text-red-500')).toHaveTextContent('First error');
        });
