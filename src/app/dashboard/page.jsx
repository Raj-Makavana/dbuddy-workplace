...
export default function DashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-background via-accent/20 to-secondary/30">
            ...
            {/* Main content */}
            <main className="p-6 max-w-7xl mx-auto space-y-8 animate-fade-in-up">
                {/* Welcome Section */}
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                    ...
                    <Card className="glass-card hover:border-secondary/30 transition-all duration-300">
                        <CardContent className="pt-6">
                            <div className="flex items-center space-x-4">
                    ...
                    <Card className="glass-card hover:border-accent-foreground/30 transition-all duration-300">
                        <CardContent className="pt-6">
                            <div className="flex items-center space-x-4">
