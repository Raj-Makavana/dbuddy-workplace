...
export default function Optimization() {
    ...
    if (loading) {
        return (
            <div className="p-8 w-full animate-slide-in-up">
                {/* Header skeleton */}
                <div className="flex items-center justify-between mb-8 p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-border/20">
                    <div className="skeleton h-8 w-56 rounded-lg" />
                    <div className="skeleton h-14 w-56 rounded-xl" />
                </div>
                {/* Card skeletons */}
                {[1, 2, 3].map(i => (
                    <div key={i} className="mb-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-border/20 p-6">
    ...
    return (
        <div style={styles.optimizationContainer} className="animate-slide-in-up">
            {/* Header Section */}
            <div style={styles.headerSection} className="animate-slide-in-down">
            ...
            {missingIndexes.length > 0 && missingIndexes.map((index, idx) => (
                <div key={`index-${idx}`} style={styles.cardAlert} className="animate-scale-in">
